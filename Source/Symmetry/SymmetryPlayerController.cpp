...
ASymmetryPlayerController::ASymmetryPlayerController()
{
	bShowMouseCursor = true;
	DefaultMouseCursor = EMouseCursor:: Default;
}

void ASymmetryPlayerController::PlayerTick(float DeltaTime)
{
...
void ASymmetryPlayerController::SetupInputComponent()
{
...
void ASymmetryPlayerController::OnSetDestinationReleased()
{
...
void ASymmetryPlayerController::OnTouchReleased(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = false;
